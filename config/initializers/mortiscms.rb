Mortiscms.config do |config|
	...
	config.publish_from_friendly_address = "Swancon 2017 Auto Mailer <donotreply@swancon.com.au>"
	config.authorization_system = :pundit
	config.user_model = "User"
	config.publish_extra_emails = [["Swancon", "community@swancon.com.au"]]
end
